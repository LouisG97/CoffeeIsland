...
if open == true{
	...
	draw_sprite_ext(spr_ui, 0, 66+textbox_x, 4+textbox_y, 1.5+espa, 1.08, 0, c_white, .8);
	draw_sprite_ext(spr_ui_gold, 0, 67+textbox_x, 6.7+textbox_y, 1, 1, 0, c_white, 1);
	draw_text(80+textbox_x,8+textbox_y, string(global.money));
	...
	if page == 1 {
		...
		draw_text(23+textbox_x,30+textbox_y, "Settings");
		draw_sprite_ext(spr_ui_options, 0, 8+textbox_x, 29+textbox_y, 1, 1, 0, c_white, 1);
		draw_text(23+textbox_x,44+textbox_y,"Missions");
		draw_sprite_ext(spr_ui_options, 1, 8+textbox_x, 43+textbox_y, 1, 1, 0, c_white, 1);
		draw_text(23+textbox_x,58+textbox_y,"Store");
		draw_sprite_ext(spr_ui_options, 2, 8+textbox_x, 57+textbox_y, 1, 1, 0, c_white, 1);
...
if open == false{
	...
	draw_sprite_ext(spr_ui, 0, 25+textbox_x, 4+textbox_y, 1.5+espa, 1.08, 0, c_white, .8);
	draw_sprite_ext(spr_ui_gold, 0, 26+textbox_x, 6.7+textbox_y, 1, 1, 0, c_white, 1);
	draw_text(39+textbox_x,8+textbox_y, string(global.money));
